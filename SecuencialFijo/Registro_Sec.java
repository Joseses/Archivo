...
public class Registro_Sec {
	...
	private byte[] eliminado = new byte[1];
       // private byte[] puntero = new byte[1];
	...
	public Registro_Sec( String nomSucursal, int numCuenta,
...
//                puntero[0]=temp.getBytes()[0];
	...
	public String getEliminado() { return new String( eliminado ); }
        ...
        //public String getPuntero() { return new String(puntero); }
...
//                raf.write( puntero);
       ...
       /* public void puntear(RandomAccessFile raf,int p) throws IOException {
